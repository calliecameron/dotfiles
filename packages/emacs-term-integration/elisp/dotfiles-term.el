...
(use-package term
  ...
  ;; Used to use multi-term for this, but it's such a pain to configure, and
  ;; it's a wiki package too, that we just do some quick setup of our own here
  ;; instead.
  ...
  (defun dotfiles-term-do-interactive-command ()
    (interactive)
    (if dotfiles--term-interactive-command
