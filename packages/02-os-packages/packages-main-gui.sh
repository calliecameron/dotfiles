...
sudo apt-get -y install biber dconf-tools dia dia-shapes dictd dict-foldoc dict-gcide dict-jargon dict-wn emacs24 emacs24-el emacs-goodies-el epstool fonts-crosextra-caladea fonts-crosextra-carlito freefilesync gimp gnucash gnucash-docs handbrake-gtk kdelibs5-plugins kdelibs5-data manpages-posix manpages-posix-dev mosh octave okular oxygen-icon-theme python-dev python3-dev python-nemo qtbase5-dev sqlite3 texlive-full transfig ttf-ancient-fonts ttf-mscorefonts-installer ubuntu-restricted-extras unoconv wmctrl workrave xclip xsane || exit 1
