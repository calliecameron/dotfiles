...
sudo apt-get -y install abcde asciidoc aspell bash-doc biber bison bison-doc build-essential chktex clang clang-format cmake cppcheck curl dconf-tools devscripts dia dia-shapes dict dictd dict-foldoc dict-gcide dict-jargon dict-wn dtrx emacs24 emacs24-el emacs-goodies-el epstool eyed3 flex fonts-crosextra-caladea fonts-crosextra-carlito gimp git global gnucash gnucash-docs handbrake-gtk htop hunspell hunspell-en-gb info inotify-tools kdelibs5-plugins kdelibs5-data make-doc lame laptop-detect man-db manpages-posix manpages-posix-dev markdown mercurial miniupnpc mosh nano ncurses-term netcat-openbsd octave okular openjdk-8-jdk oxygen-icon-theme powertop python-dev python-gnucash python-nemo python-pip python-tk python3-dev python3-pip python3-tk qtbase5-dev realpath ruby scons screen sqlite3 sshfs ssmtp tcl-dev texinfo texlive-full tk-dev tmux transfig tree ttf-ancient-fonts ttf-mscorefonts-installer ubuntu-restricted-extras unoconv valgrind vlc wdiff wmctrl workrave xclip xmlstarlet xsane xsltproc zsh zsh-doc zsh-lovers || exit 1
